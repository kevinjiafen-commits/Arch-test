...
local RageCore = (function()
    local Settings = {
        ...
        FlickbotKeybind = Enum.KeyCode.E,
        FlickbotShot = false,
        FlickbotShotDelay = 0,
...
local function UpdateFlickbot(dt)
    ...
    if key and key ~= Enum.KeyCode.Unknown then
        held = UserInputService:IsKeyDown(key)
    end
...
FlickbotGroup:Keybind({Name="Keybind",Default=Enum.KeyCode.E,Callback=function(v) if RageSettings then RageSettings.FlickbotKeybind=v end end})
