local Library = loadstring(game:HttpGet("https://pastefy.app/2eRdp0K5/raw"))()
do
    local prev = _G.ArchScript
...
local function safeCallback(fn)
    return function(...)
        ...
        if not ok then
            pcall(Notify, "Arch Script", "Error: " .. tostring(err), "Error", 4)
        end
    end
end
...
Notify("Arch Script", "Arch Script loaded successfully!", "Success", 3.5)